...
using PKT.Application.DTOs.PktTransactions;
...
public class PktTransactionsController : BaseController
{
    ...
    [HttpPost]
    public async Task<ActionResult<ApiResponse<PktTransactionDto>>> Create(CreatePktTransactionDto createDto)
    {
        var transaction = new PktTransaction
        {
            ...
            StartOfWork = createDto.StartOfWork,
            End = createDto.End,
            ActualProductionDuration = createDto.ActualProductionDuration,
            DelayDuration = createDto.DelayDuration,
            WashingDuration = createDto.WashingDuration,
